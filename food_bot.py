...
def analyze_ingredients_with_ai(ingredients_text, _api_key):
    ...
    Suggest 2-3 specific alternative healthier **packaged food options or brands** that serve a similar culinary taste/purpose but are less harmful and much closer to WHO health guidelines (e.g. less added sugar, fewer preservatives). Ensure that these suggested packaged options are directly similar in nature to the inputted product.
